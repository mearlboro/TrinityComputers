<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ram.aspx.cs" Inherits="WebStore.ram" %>
...
<div id="Content1" style="height:700px;">
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="baza.mdb" 
        SelectCommand="SELECT * FROM [MemorieRAM]"></asp:AccessDataSource>
